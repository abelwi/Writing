    ...
    <div class="relative">
        <div class="flex justify-center items-center">
            <div class="box-content w-full text-center">
                <p class="ml-1 pl-5 sm:ml-4 sm:pl-40 text-left font-semibold mt-4">Câu hỏi demo:</p>
                <p class="w-5/6 sm:w-2/3 mt-4 px-5 py-3 mx-auto border border-primary-content rounded-lg text-left shadow-inner">
                    Some people say advertising has positive economic effects. 
                ...
                <p class="ml-1 pl-5 sm:ml-4 sm:pl-40 text-left font-semibold mt-4">Câu trả lời demo:</p>
                <p class="w-5/6 sm:w-2/3 mt-4 px-5 py-3 mx-auto text-left">
                ...
                <button class="btn btn-wide btn-md btn-accent px-12 sm:w-2/5 sm:px-20 py-2 sm:py-3 mt-4 mb-14 font-bold rounded-xl drop-shadow-xl shadow-xl">
                    Chấm điểm
                </button>
            </div>
        </div>
